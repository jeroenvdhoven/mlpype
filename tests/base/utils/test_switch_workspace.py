...
from pype.base.utils.switch_workspace import (
...
def test_reset_workspace():
    ...
    with patch("pype.base.utils.switch_workspace.os") as mock_os, patch(
        "pype.base.utils.switch_workspace.sys"
    ) as mock_sys:
...
def test_create_temporary_workspace():
    ...
    with patch("pype.base.utils.switch_workspace.os.chdir") as mock_chdir, patch(
        "pype.base.utils.switch_workspace.sys"
    ) as mock_sys, patch("pype.base.utils.switch_workspace.importlib.import_module", side_effect=libs) as mock_import:
...
def test_switch_workspace():
    ...
    with patch("pype.base.utils.switch_workspace._create_temporary_workspace") as mock_create, patch(
        "pype.base.utils.switch_workspace._reset_workspace"
    ) as mock_reset, patch("pype.base.utils.switch_workspace.importlib.import_module") as mock_importlib:
        cwd = os.getcwd()
